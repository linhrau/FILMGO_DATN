  ...
  return (
    <div className="seat-type-panel flex justify-center mt-4">
      <div className="w-[100px] text-center">
        <img src={seatNormalImage} alt="Seat" className="w-[30px] h-[30px]" />
        <p>Ghế thường</p>
      </div>
      <div className="w-[100px] text-center">
        <img src={seatVIPImage} alt="Seat" className="w-[30px] h-[30px]" />
        <p>Ghế VIP</p>
      </div>
      <div className="w-[100px] text-center">
        <img src={seatCoupleImage} alt="Seat" className="w-[58px] h-[30px]" />
        <p>Ghế đôi</p>
      </div>
      <div className="w-[100px] text-center">
      <img src={seatNormalImageErr} alt="Seat" className="w-[30px] h-[30px]" />
        <p>Ghế hỏng</p>
      </div>
    </div>
  );

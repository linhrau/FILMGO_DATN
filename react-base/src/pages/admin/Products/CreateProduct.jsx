  ...
  return (
    <div>
      ...
      <Form form={form} onFinish={handleSubmit} layout="vertical">
        ...
        <Form.Item label="Ảnh combo" name="image" rules={[{ required: true, message: "Vui lòng tải lên ảnh!" }]}>
          <Upload beforeUpload={beforeUpload} maxCount={1} accept=".jpg,.jpeg,.png" fileList={fileList} listType="picture">
